...
public class Lms_lectureVO {
	private String lms_num;
	private int lvl_code;
	private String fname;
	private String duration;
	private String description;
	public Lms_lectureVO() {
	}
	public Lms_lectureVO(String lms_num, int lvl_code, String fname, String duration, String description) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Lms_lectureVO other = (Lms_lectureVO) obj;
	...
	public String toString() {
		return "Lms_lectureVO [lms_num=" + lms_num + ", lvl_code=" + lvl_code + ", fname=" + fname + ", duration="
